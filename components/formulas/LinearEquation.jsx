    ...
    <main className="solver bg-[#e7e7e7]  border border-gray-400 rounded-sm p-3 mt-3 min-h-80">
      ...
      <div className="inputs flex items-center justify-start gap-3 my-3">
        <div className="flex items-center justify-center">
          <input className="max-w-10 h-10" ref={linearTermInput} type="number" />
          <span className="variable">x</span>
        </div>
        <span className="operator">+</span>{" "}
        <input className="max-w-10 h-10" ref={constantTermInputOnLHS} type="number" />
        <span className="operator">=</span>
        <input className="max-w-10 h-10" ref={constantTermInputOnRHS} type="number" />
      </div>
